...
public class InventoryWeapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            new WeaponEquip(WeaponType.WeaponLevel1, "Gun level 1", bullets[0].GetComponent<BulletLevel1>().damageValue, bullets[0], weaponSkins[0], weaponBarrelSkins[0]),
            new WeaponEquip(WeaponType.WeaponLevel2, "Gun level 1", bullets[1].GetComponent<BulletLevel2>().damageValue, bullets[1], weaponSkins[1], weaponBarrelSkins[1])
        };
    ...
    {
        SpriteRenderer spriteHeavyHull = heavyHull.GetComponent<SpriteRenderer>();
        if (spriteHeavyHull != null)
        {
            spriteHeavyHull.sprite = weaponSelected.weaponSkin;
        }
        SpriteRenderer spriteBarrel = barrel.GetComponent<SpriteRenderer>();
        if (spriteBarrel != null)
        {
            spriteBarrel.sprite = weaponSelected.weaponBarrelSkin;
        }
    }
