...
public class StatisticsPlayer : MonoBehaviour
{
    ...
    {
        elapsedTime = 0f;
        totalCoin += value; if (spriteRenderer != null)
        {
    ...
    private IEnumerator MoveAndFadeCoroutine()
    {
        while (elapsedTime < fadeDuration)
        {
            ...
            textCoinMessageValue.transform.position = new Vector3(textCoinMessageValue.transform.position.x, newY, textCoinMessageValue.transform.position.z);
            if (spriteRenderer != null)
            {
