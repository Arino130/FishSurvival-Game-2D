...
public class InventoryWeapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            new WeaponEquip(WeaponType.WeaponLevel1, "Gun 1", bullet.GetComponent<BulletLevel1>().damageValue, bullet[0]),
            new WeaponEquip(WeaponType.WeaponLevel2, "Gun 2", bullet.GetComponent<BulletLevel2>().damageValue, bullet[1])
        };
