...
public class InventoryWeapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            new WeaponEquip(WeaponType.WeaponLevel1, "Gun 1", bullets[0].GetComponent<BulletLevel1>().damageValue, bullet[0], weaponSkins[0], weaponBarrelSkins[0]),
            new WeaponEquip(WeaponType.WeaponLevel2, "Gun 2", bullets[1].GetComponent<BulletLevel2>().damageValue, bullet[1], weaponSkins[1], weaponBarrelSkins[1])
        };
