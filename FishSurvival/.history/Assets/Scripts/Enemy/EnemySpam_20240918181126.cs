        ...
        while (true)
        {
            ...
            switch (level)
            {
                case 1:
                    ...
                    fishChoose = Instantiate(fishLevel1, new UnityEngine.Vector3(transform.position.x, randomY, -1f), fishLevel1.transform.rotation, enemyFolder);
                    fishChoose.GetComponent<FishLevel1Moving>().updateSpamPosition(spamPosition);
                    break;
                case 5:
